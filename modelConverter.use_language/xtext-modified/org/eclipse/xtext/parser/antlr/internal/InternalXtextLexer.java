...
public class InternalXtextLexer extends Lexer {
    ...
    public InternalXtextLexer(CharStream_FIX input) {
        this(input, new RecognizerSharedState_FIX());
    }
    public InternalXtextLexer(CharStream_FIX input, RecognizerSharedState_FIX state) {
        super(input,state);
            	...
            	default :
            	    if ( cnt3 >= 1 ) break loop3;
                        EarlyExitException_FIX eee =
                            new EarlyExitException_FIX(3, input);
                        throw eee;
                }
                cnt3++;
            } while (true);
        ...
        try {
            ...
            if ( (LA6_0=='\"') ) {
                ...
                NoViableAltException_FIX nvae =
                    new NoViableAltException_FIX("", 6, 0, input);
    ...
    static class DFA12 extends DFA_FIX {
