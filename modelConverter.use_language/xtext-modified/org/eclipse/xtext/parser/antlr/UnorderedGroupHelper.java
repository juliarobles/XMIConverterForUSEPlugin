...
import fixerror.antlr.BaseRecognizer_FIX;
...
public class UnorderedGroupHelper implements IUnorderedGroupHelper {
	...
	private BaseRecognizer_FIX recognizer;
	...
	@Override
	public void initializeWith(BaseRecognizer_FIX recognizer) {
		this.recognizer = recognizer;
	}
	
	protected BaseRecognizer_FIX getRecognizer() {
		return recognizer;
	}
