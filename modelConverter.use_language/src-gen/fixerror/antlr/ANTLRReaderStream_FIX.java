...
*/
public class ANTLRReaderStream_FIX extends ANTLRStringStream_FIX {
	public static final int READ_BUFFER_SIZE = 1024;
	public static final int INITIAL_BUFFER_SIZE = 1024;

	public ANTLRReaderStream_FIX() {
	}

	public ANTLRReaderStream_FIX(Reader r) throws IOException {
		this(r, INITIAL_BUFFER_SIZE, READ_BUFFER_SIZE);
	}

	public ANTLRReaderStream_FIX(Reader r, int size) throws IOException {
		this(r, size, READ_BUFFER_SIZE);
	}

	public ANTLRReaderStream_FIX(Reader r, int size, int readChunkSize) throws IOException {
