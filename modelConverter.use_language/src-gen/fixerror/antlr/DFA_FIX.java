...
public class DFA_FIX {
   ...
   protected short[][] transition;
	...
	protected BaseRecognizer_FIX recognizer;
	 ...
	 */
	public int predict(IntStream_FIX input)
		throws RecognitionException_FIX
	{
		...
		try {
			while ( true ) {
				...
				if ( c==(char)Token_FIX.EOF && eof[s]>=0 ) {  // EOF Transition to accept state?
	...
	protected void noViableAlt(int s, IntStream_FIX input) throws NoViableAltException_FIX {
		if (recognizer.state.backtracking>0) {
			recognizer.state.failed=true;
			return;
		}
		NoViableAltException_FIX nvae =
			new NoViableAltException_FIX(getDescription(),
									 decisionNumber,
									 s,
									 input);
		error(nvae);
	...
	protected void error(NoViableAltException_FIX nvae) { ; }

	public int specialStateTransition(int s, IntStream_FIX input)
		throws NoViableAltException_FIX
	{
		return -1;
	}
